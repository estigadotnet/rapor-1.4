...
<?php if ($t001_sekolah_list->Alamat->Visible) { // Alamat ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($t001_sekolah_list->KepalaSekolah->Visible) { // KepalaSekolah ?>
	<?php if ($t001_sekolah_list->SortUrl($t001_sekolah_list->KepalaSekolah) == "") { ?>
		<th data-name="KepalaSekolah" class="<?php echo $t001_sekolah_list->KepalaSekolah->headerCellClass() ?>"><div id="elh_t001_sekolah_KepalaSekolah" class="t001_sekolah_KepalaSekolah"><div class="ew-table-header-caption"><?php echo $t001_sekolah_list->KepalaSekolah->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="KepalaSekolah" class="<?php echo $t001_sekolah_list->KepalaSekolah->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t001_sekolah_list->SortUrl($t001_sekolah_list->KepalaSekolah) ?>', 2);"><div id="elh_t001_sekolah_KepalaSekolah" class="t001_sekolah_KepalaSekolah">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $t001_sekolah_list->KepalaSekolah->caption() ?><?php echo $Language->phrase("SrchLegend") ?></span><span class="ew-table-header-sort"><?php if ($t001_sekolah_list->KepalaSekolah->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($t001_sekolah_list->KepalaSekolah->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($t001_sekolah_list->NIPKepalaSekolah->Visible) { // NIPKepalaSekolah ?>
	<?php if ($t001_sekolah_list->SortUrl($t001_sekolah_list->NIPKepalaSekolah) == "") { ?>
		<th data-name="NIPKepalaSekolah" class="<?php echo $t001_sekolah_list->NIPKepalaSekolah->headerCellClass() ?>"><div id="elh_t001_sekolah_NIPKepalaSekolah" class="t001_sekolah_NIPKepalaSekolah"><div class="ew-table-header-caption"><?php echo $t001_sekolah_list->NIPKepalaSekolah->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="NIPKepalaSekolah" class="<?php echo $t001_sekolah_list->NIPKepalaSekolah->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t001_sekolah_list->SortUrl($t001_sekolah_list->NIPKepalaSekolah) ?>', 2);"><div id="elh_t001_sekolah_NIPKepalaSekolah" class="t001_sekolah_NIPKepalaSekolah">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $t001_sekolah_list->NIPKepalaSekolah->caption() ?><?php echo $Language->phrase("SrchLegend") ?></span><span class="ew-table-header-sort"><?php if ($t001_sekolah_list->NIPKepalaSekolah->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($t001_sekolah_list->NIPKepalaSekolah->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
<span<?php echo $t001_sekolah_list->Alamat->viewAttributes() ?>><?php echo $t001_sekolah_list->Alamat->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($t001_sekolah_list->KepalaSekolah->Visible) { // KepalaSekolah ?>
		<td data-name="KepalaSekolah" <?php echo $t001_sekolah_list->KepalaSekolah->cellAttributes() ?>>
<span id="el<?php echo $t001_sekolah_list->RowCount ?>_t001_sekolah_KepalaSekolah">
<span<?php echo $t001_sekolah_list->KepalaSekolah->viewAttributes() ?>><?php echo $t001_sekolah_list->KepalaSekolah->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($t001_sekolah_list->NIPKepalaSekolah->Visible) { // NIPKepalaSekolah ?>
		<td data-name="NIPKepalaSekolah" <?php echo $t001_sekolah_list->NIPKepalaSekolah->cellAttributes() ?>>
<span id="el<?php echo $t001_sekolah_list->RowCount ?>_t001_sekolah_NIPKepalaSekolah">
<span<?php echo $t001_sekolah_list->NIPKepalaSekolah->viewAttributes() ?>><?php echo $t001_sekolah_list->NIPKepalaSekolah->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
