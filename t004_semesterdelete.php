...
<?php if ($t004_semester_delete->id->Visible) { // id ?>
		<th class="<?php echo $t004_semester_delete->id->headerCellClass() ?>"><span id="elh_t004_semester_id" class="t004_semester_id"><?php echo $t004_semester_delete->id->caption() ?></span></th>
<?php } ?>
...
<?php if ($t004_semester_delete->id->Visible) { // id ?>
		<td <?php echo $t004_semester_delete->id->cellAttributes() ?>>
<span id="el<?php echo $t004_semester_delete->RowCount ?>_t004_semester_id" class="t004_semester_id">
<span<?php echo $t004_semester_delete->id->viewAttributes() ?>><?php echo $t004_semester_delete->id->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($t004_semester_delete->Semester->Visible) { // Semester ?>
