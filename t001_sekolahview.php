...
<?php } ?>
<?php if ($t001_sekolah_view->KepalaSekolah->Visible) { // KepalaSekolah ?>
	<tr id="r_KepalaSekolah">
		<td class="<?php echo $t001_sekolah_view->TableLeftColumnClass ?>"><span id="elh_t001_sekolah_KepalaSekolah"><?php echo $t001_sekolah_view->KepalaSekolah->caption() ?></span></td>
		<td data-name="KepalaSekolah" <?php echo $t001_sekolah_view->KepalaSekolah->cellAttributes() ?>>
<span id="el_t001_sekolah_KepalaSekolah">
<span<?php echo $t001_sekolah_view->KepalaSekolah->viewAttributes() ?>><?php echo $t001_sekolah_view->KepalaSekolah->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t001_sekolah_view->NIPKepalaSekolah->Visible) { // NIPKepalaSekolah ?>
	<tr id="r_NIPKepalaSekolah">
		<td class="<?php echo $t001_sekolah_view->TableLeftColumnClass ?>"><span id="elh_t001_sekolah_NIPKepalaSekolah"><?php echo $t001_sekolah_view->NIPKepalaSekolah->caption() ?></span></td>
		<td data-name="NIPKepalaSekolah" <?php echo $t001_sekolah_view->NIPKepalaSekolah->cellAttributes() ?>>
<span id="el_t001_sekolah_NIPKepalaSekolah">
<span<?php echo $t001_sekolah_view->NIPKepalaSekolah->viewAttributes() ?>><?php echo $t001_sekolah_view->NIPKepalaSekolah->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
