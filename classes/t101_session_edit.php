 ...
 * Page class
 */
class t101_session_edit extends t101_session
{
	...
	// Page object name
	public $PageObjName = "t101_session_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// tanggal_jam
			$this->tanggal_jam->setDbValueDef($rsnew, UnFormatDateTime($this->tanggal_jam->CurrentValue, 0), CurrentDate(), $this->tanggal_jam->ReadOnly);

			// session_value
			$this->session_value->setDbValueDef($rsnew, $this->session_value->CurrentValue, "", $this->session_value->ReadOnly);
