...
/**
 * Table class for t205_default
 */
class t205_default extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 't205_default';
		$this->TableName = 't205_default';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t205_default`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('t205_default', 't205_default', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// User_ID
		$this->User_ID = new DbField('t205_default', 't205_default', 'x_User_ID', 'User_ID', '`User_ID`', '`User_ID`', 3, 11, -1, FALSE, '`User_ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`t205_default`";
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "t205_defaultedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "t205_defaultadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("t205_defaultview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("t205_defaultview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "t205_defaultadd.php?" . $this->getUrlParm($parm);
		else
			$url = "t205_defaultadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t205_defaultedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t205_defaultadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("t205_defaultdelete.php", $this->getUrlParm());
	}
