 ...
 * Page class
 */
class t101_session_delete extends t101_session
{
	...
	// Page object name
	public $PageObjName = "t101_session_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t101_sessionlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t101_sessionlist.php"); // Return to list
			}
		}
	}
