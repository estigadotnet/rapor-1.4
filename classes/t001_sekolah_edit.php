 ...
 * Page class
 */
class t001_sekolah_edit extends t001_sekolah
{
	...
	// Page object name
	public $PageObjName = "t001_sekolah_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// KepalaSekolah
			$this->KepalaSekolah->setDbValueDef($rsnew, $this->KepalaSekolah->CurrentValue, NULL, $this->KepalaSekolah->ReadOnly);

			// NIPKepalaSekolah
			$this->NIPKepalaSekolah->setDbValueDef($rsnew, $this->NIPKepalaSekolah->CurrentValue, NULL, $this->NIPKepalaSekolah->ReadOnly);
