 ...
 * Page class
 */
class t201_employees_delete extends t201_employees
{
	...
	// Page object name
	public $PageObjName = "t201_employees_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t201_employeeslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($rs = LoadRecordset($sql, $conn)) {
			...
			$rs->close();
			if (!$res) {
				$this->terminate("t201_employeeslist.php"); // Return to list
				return;
			}
		}
