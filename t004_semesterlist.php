...
?>
<?php if ($t004_semester_list->id->Visible) { // id ?>
	<?php if ($t004_semester_list->SortUrl($t004_semester_list->id) == "") { ?>
		<th data-name="id" class="<?php echo $t004_semester_list->id->headerCellClass() ?>"><div id="elh_t004_semester_id" class="t004_semester_id"><div class="ew-table-header-caption"><?php echo $t004_semester_list->id->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id" class="<?php echo $t004_semester_list->id->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t004_semester_list->SortUrl($t004_semester_list->id) ?>', 2);"><div id="elh_t004_semester_id" class="t004_semester_id">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $t004_semester_list->id->caption() ?></span><span class="ew-table-header-sort"><?php if ($t004_semester_list->id->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($t004_semester_list->id->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($t004_semester_list->Semester->Visible) { // Semester ?>
	...
	<?php } else { ?>
		<th data-name="Semester" class="<?php echo $t004_semester_list->Semester->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t004_semester_list->SortUrl($t004_semester_list->Semester) ?>', 2);"><div id="elh_t004_semester_Semester" class="t004_semester_Semester">
...
?>
	<?php if ($t004_semester_list->id->Visible) { // id ?>
		<td data-name="id" <?php echo $t004_semester_list->id->cellAttributes() ?>>
<span id="el<?php echo $t004_semester_list->RowCount ?>_t004_semester_id">
<span<?php echo $t004_semester_list->id->viewAttributes() ?>><?php echo $t004_semester_list->id->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($t004_semester_list->Semester->Visible) { // Semester ?>
