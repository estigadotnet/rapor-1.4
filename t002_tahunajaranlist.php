...
<?php if ($t002_tahunajaran_list->Mulai->Visible) { // Mulai ?>
	...
	<?php } else { ?>
		<th data-name="Mulai" class="<?php echo $t002_tahunajaran_list->Mulai->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t002_tahunajaran_list->SortUrl($t002_tahunajaran_list->Mulai) ?>', 2);"><div id="elh_t002_tahunajaran_Mulai" class="t002_tahunajaran_Mulai">
...
<?php if ($t002_tahunajaran_list->Selesai->Visible) { // Selesai ?>
	...
	<?php } else { ?>
		<th data-name="Selesai" class="<?php echo $t002_tahunajaran_list->Selesai->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t002_tahunajaran_list->SortUrl($t002_tahunajaran_list->Selesai) ?>', 2);"><div id="elh_t002_tahunajaran_Selesai" class="t002_tahunajaran_Selesai">
