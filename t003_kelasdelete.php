...
<?php if ($t003_kelas_delete->id->Visible) { // id ?>
		<th class="<?php echo $t003_kelas_delete->id->headerCellClass() ?>"><span id="elh_t003_kelas_id" class="t003_kelas_id"><?php echo $t003_kelas_delete->id->caption() ?></span></th>
<?php } ?>
...
<?php if ($t003_kelas_delete->id->Visible) { // id ?>
		<td <?php echo $t003_kelas_delete->id->cellAttributes() ?>>
<span id="el<?php echo $t003_kelas_delete->RowCount ?>_t003_kelas_id" class="t003_kelas_id">
<span<?php echo $t003_kelas_delete->id->viewAttributes() ?>><?php echo $t003_kelas_delete->id->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($t003_kelas_delete->Kelas->Visible) { // Kelas ?>
