...
?>
<?php if ($t003_kelas_list->id->Visible) { // id ?>
	<?php if ($t003_kelas_list->SortUrl($t003_kelas_list->id) == "") { ?>
		<th data-name="id" class="<?php echo $t003_kelas_list->id->headerCellClass() ?>"><div id="elh_t003_kelas_id" class="t003_kelas_id"><div class="ew-table-header-caption"><?php echo $t003_kelas_list->id->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id" class="<?php echo $t003_kelas_list->id->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t003_kelas_list->SortUrl($t003_kelas_list->id) ?>', 2);"><div id="elh_t003_kelas_id" class="t003_kelas_id">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $t003_kelas_list->id->caption() ?></span><span class="ew-table-header-sort"><?php if ($t003_kelas_list->id->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($t003_kelas_list->id->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($t003_kelas_list->Kelas->Visible) { // Kelas ?>
	...
	<?php } else { ?>
		<th data-name="Kelas" class="<?php echo $t003_kelas_list->Kelas->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t003_kelas_list->SortUrl($t003_kelas_list->Kelas) ?>', 2);"><div id="elh_t003_kelas_Kelas" class="t003_kelas_Kelas">
...
?>
	<?php if ($t003_kelas_list->id->Visible) { // id ?>
		<td data-name="id" <?php echo $t003_kelas_list->id->cellAttributes() ?>>
<span id="el<?php echo $t003_kelas_list->RowCount ?>_t003_kelas_id">
<span<?php echo $t003_kelas_list->id->viewAttributes() ?>><?php echo $t003_kelas_list->id->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($t003_kelas_list->Kelas->Visible) { // Kelas ?>
