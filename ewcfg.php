...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "p_rapor_1_4"); // Project name
...
$CONFIG = [
	...
	"RANDOM_KEY" => '02bn9Z12Ij2lHyWa', // Random key for encryption
	...
	"PROJECT_ID" => "{3C5552E0-8BEE-4542-ADE6-BB9DE9BAE233}", // Project ID (GUID)
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => 3307, "user" => "root", "pass" => "admin", "db" => "db_rapor_1_4"]
	],
	...
	"USER_TABLE_NAME" => "t201_employees",
