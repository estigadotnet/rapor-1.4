...
<?php } ?>
<?php if ($t001_sekolah_delete->NIPKepalaSekolah->Visible) { // NIPKepalaSekolah ?>
		<th class="<?php echo $t001_sekolah_delete->NIPKepalaSekolah->headerCellClass() ?>"><span id="elh_t001_sekolah_NIPKepalaSekolah" class="t001_sekolah_NIPKepalaSekolah"><?php echo $t001_sekolah_delete->NIPKepalaSekolah->caption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($t001_sekolah_delete->KepalaSekolah->Visible) { // KepalaSekolah ?>
		<td <?php echo $t001_sekolah_delete->KepalaSekolah->cellAttributes() ?>>
<span id="el<?php echo $t001_sekolah_delete->RowCount ?>_t001_sekolah_KepalaSekolah" class="t001_sekolah_KepalaSekolah">
<span<?php echo $t001_sekolah_delete->KepalaSekolah->viewAttributes() ?>><?php echo $t001_sekolah_delete->KepalaSekolah->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($t001_sekolah_delete->NIPKepalaSekolah->Visible) { // NIPKepalaSekolah ?>
		<td <?php echo $t001_sekolah_delete->NIPKepalaSekolah->cellAttributes() ?>>
<span id="el<?php echo $t001_sekolah_delete->RowCount ?>_t001_sekolah_NIPKepalaSekolah" class="t001_sekolah_NIPKepalaSekolah">
<span<?php echo $t001_sekolah_delete->NIPKepalaSekolah->viewAttributes() ?>><?php echo $t001_sekolah_delete->NIPKepalaSekolah->getViewValue() ?></span>
</span>
</td>
<?php } ?>
	</tr>
