...
<?php if ($t004_semester_view->id->Visible) { // id ?>
	<tr id="r_id">
		<td class="<?php echo $t004_semester_view->TableLeftColumnClass ?>"><span id="elh_t004_semester_id"><?php echo $t004_semester_view->id->caption() ?></span></td>
		<td data-name="id" <?php echo $t004_semester_view->id->cellAttributes() ?>>
<span id="el_t004_semester_id">
<span<?php echo $t004_semester_view->id->viewAttributes() ?>><?php echo $t004_semester_view->id->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
