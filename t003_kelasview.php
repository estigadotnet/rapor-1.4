...
<?php if ($t003_kelas_view->id->Visible) { // id ?>
	<tr id="r_id">
		<td class="<?php echo $t003_kelas_view->TableLeftColumnClass ?>"><span id="elh_t003_kelas_id"><?php echo $t003_kelas_view->id->caption() ?></span></td>
		<td data-name="id" <?php echo $t003_kelas_view->id->cellAttributes() ?>>
<span id="el_t003_kelas_id">
<span<?php echo $t003_kelas_view->id->viewAttributes() ?>><?php echo $t003_kelas_view->id->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
